  ...
  <body style="background:#f2f2f2;">
    ...
    <div id="main" style="background:#f2f2f2;">
      ...
      <div id="gtrx" style="text-align:center">
        <div onclick="ldfrm()" id="gtr01" style="margin-top: 20px;display: inline-block; width: 310px;height:500px;background-image:url('./im/frm3.svg');background-repeat:no-repeat;">
